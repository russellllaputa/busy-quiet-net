...
class GroupNormalize_v2(object):
    """(C x D x H x W) """
    def __init__(self, mean, std):
        self.mean = mean
        self.std = std
...
class ToTorchFormatTensor_v2(object):
    """ Converts a numpy.ndarray (D x H x W x C) in the range [0, 255]
